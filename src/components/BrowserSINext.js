const BrowserSINext = ({ browserSINextImageW, dawnbreaker }) => {
  return (
    <div className="h-[178px] flex flex-col items-start justify-start pt-0 px-0 pb-[36.4px] box-border relative gap-[21.6px] max-w-full text-left text-lgi text-white font-rajdhani">
      ...
      />
      <div className="w-[305.7px] flex flex-row items-start justify-start py-0 pr-6 pl-[23.7px] box-border">
